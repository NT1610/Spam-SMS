...
hehe = "https://www.facebook.com/langthanghanoiofficial/posts/pfbid0gGc5F6ARLPz4oLSZee9w82Q7KuasUoWX2t4nZDjKpGJWoMkDSVGX1W8zvpLfStWtl"
...
with sync_playwright() as p:
    ...
    # page.get_by_label("Email address or phone number").locator("nth=0").fill(ACCOUNT)
    # page.wait_for_timeout(500)

    # page.get_by_label("Password").locator("nth=1").fill(PASS)
    # page.wait_for_timeout(500)
