## Facebook info
ACCOUNT = "ngocthaint1610@gmail.com"  # your account
PASS = "thai1610"  # your password

# USER_DATA_DIR = "C:\\Users\\admin\\AppData\\Local\\Google\\Chrome\\User Data\\"  # path to chrome user data
